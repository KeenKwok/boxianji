...
[拨弦记｜演出档案](https://boxianji.guitarkk.com/archive/)
...
其中，「拨弦记｜演出情报」持续收录近期值得关注的弹拨乐演出，支持按城市快速筛选；「拨弦记｜演出档案」保存全部历史演出记录，并按年份、月份及城市提供检索。
...
`_data/attention.yml` → 演出情报 / 演出档案 / RSS / JSON
...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v1.3.0 | 2026-09-16 | 新增演出档案页面，保存全部历史演出记录，并支持按年份、月份及城市筛选；演出情报页面调整为近期演出与最近 5 场已结束演出的展示结构。 |
